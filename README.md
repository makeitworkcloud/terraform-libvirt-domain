...
| <a name="input_boot_rebuild_token"></a> [boot\_rebuild\_token](#input\_boot\_rebuild\_token) | Non-null forces boot-volume and domain replacement. Never remove or change it after a confirmed rebuild. | `string` | `null` | no |
...
| <a name="input_cloudinit_network_config_vars"></a> [cloudinit\_network\_config\_vars](#input\_cloudinit\_network\_config\_template) | Variable map for the cloud-init network configuration. | `map(string)` | n/a | yes |
...
| <a name="input_cloudinit_user_data_vars"></a> [cloudinit\_user\_data\_vars](#input\_cloudinit\_user\_data\_template) | Variable map for the cloud-init user-data template. Set to {} if not used. | `map(string)` | n/a | yes |
